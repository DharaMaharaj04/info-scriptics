    ...
    return (
      <div>
        <div className="service-page">
            <Helmet>
                <title>Scritpics | SalesforceSalesCloud</title>
                <meta name="description" content= "SalesforceSalesCloud" />
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-sm-12 col-md-6 col-1g-6 fadeInUp  Wow from-right">
                            <div className="sale-info-img per100">
                                <img src='/assets/img/Banking-saleforce-21.png' alt='Banking-saleforce' />
                            </div>
                        </div>
