                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-sm-12 col-lg-6">
                                ...
                                <h2 className="">Wearable Computing</h2>
                                <div className="srv-excerpt">
                                    <p>Expand the possibilities and explore new horizons with our advanced wearable computing solutions</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="srv-con col-12 col-sm-12 col-md-12 col-lg-12" style={{paddingTop:50}}>
                                <div className="srv-info">
                                    <p className="srv-info">Scriptics provides comprehensive wearable computing app development services to deliver cohesive solutions: </p>
                                </div>
                            </div>
                        </div>
                    </div>
