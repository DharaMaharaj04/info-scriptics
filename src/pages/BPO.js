        ...
        <div>
            ...
            <section className="case-study-inner" style={{background:`url(/assets/img/ai-banner.png) no-repeat`}}>
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-sm-3 col-md-4 col-lg-4 cs-main fadeInUp  Wow from-left">
            ...
            <section className="case-study">
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-4 fadeInUp  Wow from-right">
                            <hr />
                            <h2 className="title-txt cs">Overview</h2>
                        </div>
                        <div className="col-12 col-sm-12 col-md-12 col-lg-8 fadeInUp  Wow from-left">
            ...
            <section className="case-study-art">
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-sm-12 col-md-12 col-lg-4 cs-left fadeInUp  Wow from-bottom">
                            <img src="/assets/img/cs-left.png" alt="case study left featuremedia"/>
                        </div>
                        <div className="col-12 col-sm-12 col-md-12 col-lg-8 cs-right fadeInUp  Wow from-bottom">
                ...
                <div className="container">
                    <div className="row">
                       <div className="col-12 col-sm-12 col-md-12 col-lg-4 fadeInUp  Wow from-right">
                        ...
                        <div className="col-12 col-sm-12 col-md-12 col-lg-8 bottom">
